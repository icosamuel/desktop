 ...
 * repository.
 */
export class PushButton extends React.Component<IPushButtonProps, {}> {
  public render() {
    ...
    const nothingToPush = this.props.aheadBehind
      ? this.props.aheadBehind.ahead === 0
      : false

    const disabled = !validState || networkActive || nothingToPush
